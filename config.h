...
static const char col_gray2[]       = "#283457";
...
static const char *dmenu_desktop[] = { 
    "sh", 
    "-c", 
    "j4-dmenu-desktop --no-generic --dmenu=\"dmenu -m $1 -fn '$2' -nb '$3' -nf '$4' -sb '$5' -sf '$6'\"", 
    "sh",
    dmenumon,
    dmenufont,
    col_gray1,
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_space,  spawn,          {.v = dmenu_desktop } },
    { MODKEY,                       XK_t,      spawn,          SHCMD("st") },
    { MODKEY,                       XK_b,      spawn,          SHCMD("brave-browser-nightly") },
	{ 0,                            XK_Print,  spawn,          SHCMD("~/.config/dwm/screenshot.sh") },
	{ MODKEY,                       XK_Print,  spawn,          SHCMD("~/.config/dwm/screenrec.sh") },
